...
<div class="mp-container">
  ...
  <div class="wf-pane <?= $activeTab==='new'?'active':'' ?>" id="appt-pane-new">
    ...
    <form method="POST">
      ...
      <div class="mem-form-row mem-form-row-2">
        <div class="mem-form-group">
          <label class="mem-form-label"><i class="fas fa-calendar" style="color:var(--primary-color);margin-right:4px"></i><?php echo $_t('मनपर्ने मिति', 'Preferred Date'); ?> <span class="mem-form-required">*</span></label>
        ...
        <div class="mem-form-group">
          <label class="mem-form-label"><i class="fas fa-clock" style="color:var(--primary-color);margin-right:4px"></i><?php echo $_t('मनपर्ने समय', 'Preferred Time'); ?> <span class="mem-form-required">*</span></label>
  ...
  <div class="wf-pane <?= $activeTab==='history'?'active':'' ?>" id="appt-pane-history">
    ...
    <div style="padding:40px 0;text-align:center;">
      <i class="fas fa-calendar-xmark" style="font-size:2rem;color:var(--text-muted,#9ca3af);display:block;margin-bottom:10px;"></i>
      <div style="font-weight:600;color:var(--text-primary,#1a2e1f);margin-bottom:4px;"><?php echo $_t('कुनै भेटघाट छैन', 'No appointments yet'); ?></div>
      <div style="font-size:.82rem;color:var(--text-muted,#6b7280);"><?php echo $_t('"नयाँ बुकिङ" बाट भेटघाट बुक गर्नुहोस्।', 'Use "New Booking" tab to book.'); ?></div>
    </div>
    <?php else: ?>
    ...
    <div class="recent-card">
      <div>
        <div style="font-size:.87rem;font-weight:600;color:var(--text-primary,#1a2e1f)"><?= $purposeLabel ?></div>
        <div style="font-size:.75rem;color:var(--text-muted,#6b7280);margin-top:3px">
          <i class="fas fa-calendar fa-xs" style="margin-right:3px;"></i><?= htmlspecialchars($ap['preferred_date'] ?? '') ?>
          <?php if (!empty($ap['preferred_time'])): ?> &nbsp;·&nbsp; <i class="fas fa-clock fa-xs" style="margin-right:3px;"></i><?= htmlspecialchars($ap['preferred_time']) ?><?php endif; ?>
        </div>
      </div>
