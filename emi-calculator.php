...
.loan-type-btn.active { background: var(--primary-color); color: #fff; border-color: var(--primary-color); }
#scheduleCard .table th, #scheduleCard .table td { white-space: nowrap; }
.year-row { background: #e8f5e9 !important; font-weight: 700; }
@media print {
    ...
    body { font-size:12px; }
    .card-header { background:var(--primary-color) !important; color:#fff !important; -webkit-print-color-adjust:exact; }
    .table-dark { background:#333 !important; color:#fff !important; -webkit-print-color-adjust:exact; }
    .year-row { background:#d4edda !important; -webkit-print-color-adjust:exact; }
