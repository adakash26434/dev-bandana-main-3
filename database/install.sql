...
('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'Administrator', 'admin@example.com', 'super_admin');
...
INSERT IGNORE INTO site_settings (setting_key, setting_value, setting_type, setting_label, setting_group) VALUES
('site_name', 'आकाश बचत तथा ऋण सहकारी संस्था', 'text', 'Site Name (Nepali)', 'general'),
('site_name_en', 'Aakash Saving and Credit Cooperative', 'text', 'Site Name (English)', 'general'),
('site_slogan', 'समुदायमा आधारित सक्षम र दिगो वित्तीय सहकारी संस्था', 'text', 'Site Slogan', 'general'),
('site_url', '', 'url', 'Website URL (Domain)', 'general'),
('card_prefix', '', 'text', 'Card Prefix (3 letters, optional)', 'general'),
('phone', '061590067', 'text', 'Phone Number', 'contact'),
('mobile', '9827157000', 'text', 'Mobile Number', 'contact'),
('email', 'info@aakashcoop.com.np', 'text', 'Email Address', 'contact'),
('address', 'काठमाडौं, नेपाल', 'text', 'Address', 'contact'),
('facebook_url', 'https://facebook.com/', 'url', 'Facebook URL', 'social'),
('youtube_url', 'https://youtube.com/', 'url', 'YouTube URL', 'social'),
('twitter_url', '', 'url', 'Twitter URL', 'social'),
('instagram_url', '', 'url', 'Instagram URL', 'social'),
('about_short', 'आकाश बचत तथा ऋण सहकारी संस्था लि. एक अग्रणी वित्तीय संस्था हो जसले समुदायमा आधारित बचत र ऋण सेवाहरू प्रदान गर्दछ।', 'textarea', 'Short About Text', 'general'),
('hero_title', 'तपाईंको भविष्यको लागि बचत गर्नुहोस्', 'text', 'Hero Title', 'homepage'),
('hero_subtitle', 'हामीसँग बचत गर्नुहोस्, सुरक्षित भविष्य बनाउनुहोस्', 'text', 'Hero Subtitle', 'homepage'),
('logo', 'assets/images/logo.png', 'image', 'Site Logo', 'general'),
('footer_text', '© 2026 आकाश बचत तथा ऋण सहकारी संस्था लि. सर्वाधिकार सुरक्षित।', 'text', 'Footer Copyright Text', 'general'),
('internet_banking_url', 'https://ibanking.example.com', 'url', 'Internet Banking URL', 'links'),
('play_store_url', 'https://play.google.com/store/apps', 'url', 'Google Play Store App URL', 'links'),
('app_store_url', 'https://apps.apple.com', 'url', 'Apple App Store URL', 'links'),
('whatsapp_number', '9779827157000', 'text', 'WhatsApp Number', 'contact'),
('developer_name', 'Tanka Adhikari', 'text', 'Developer Name', 'general'),
('developer_url', 'https://www.tankaadhikari.com.np/', 'url', 'Developer Website URL', 'general'),
('google_map_url', '', 'textarea', 'Google Map Embed URL', 'contact'),
('working_hours', 'आइतबार - शुक्रबार: बिहान १०:०० - साँझ ५:००', 'text', 'Working Hours', 'contact'),
('primary_color', '#1a5f2a', 'color', 'Primary Theme Color', 'theme'),
('footer_color', '#1a5f2a', 'color', 'Footer Theme Color', 'theme')
...
-- Sample notices
INSERT IGNORE INTO notices (title, title_np, content, content_np, notice_date, is_active, is_popup) VALUES
('नयाँ शाखा उद्घाटन सम्बन्धी सूचना', 'नयाँ शाखा उद्घाटन सम्बन्धी सूचना', 'हाम्रो संस्थाको नयाँ शाखा काठमाडौंमा उद्घाटन भएको जानकारी गराउँछौं।', 'हाम्रो संस्थाको नयाँ शाखा काठमाडौंमा उद्घाटन भएको जानकारी गराउँछौं।', CURDATE(), 1, 0),
('वार्षिक साधारण सभा सम्बन्धी सूचना', 'वार्षिक साधारण सभा सम्बन्धी सूचना', 'आगामी महिनामा हुने वार्षिक साधारण सभामा सबै सदस्यहरूलाई उपस्थित हुन अनुरोध छ।', 'आगामी महिनामा हुने वार्षिक साधारण सभामा सबै सदस्यहरूलाई उपस्थित हुन अनुरोध छ।', CURDATE(), 1, 0);
...
INSERT IGNORE INTO interest_rates (category, name, name_np, rate, description, display_order) VALUES
('saving', 'Regular Saving', 'नियमित बचत', 8.00, 'दैनिक बचत खाता', 1),
('saving', 'Fixed Deposit (1 Year)', 'मुद्दती बचत (१ वर्ष)', 12.00, 'एक वर्षे मुद्दती खाता', 2),
('saving', 'Fixed Deposit (2 Years)', 'मुद्दती बचत (२ वर्ष)', 13.00, 'दुई वर्षे मुद्दती खाता', 3),
('saving', 'Child Saving', 'बाल बचत', 10.00, 'बालबालिकाको लागि विशेष बचत', 4),
('saving', 'Women Saving', 'महिला बचत', 10.50, 'महिलाहरूको लागि विशेष बचत', 5),
('loan', 'Personal Loan', 'व्यक्तिगत ऋण', 14.00, 'व्यक्तिगत प्रयोजनको लागि', 1),
('loan', 'Business Loan', 'व्यवसायिक ऋण', 13.00, 'व्यवसाय विस्तारको लागि', 2),
('loan', 'Education Loan', 'शैक्षिक ऋण', 11.00, 'शिक्षाको लागि विशेष ऋण', 3),
('loan', 'Home Loan', 'घर कर्जा', 12.00, 'घर निर्माण तथा खरिदको लागि', 4),
('loan', 'Vehicle Loan', 'सवारी साधन ऋण', 13.50, 'सवारी साधन खरिदको लागि', 5),
('loan', 'Agriculture Loan', 'कृषि ऋण', 10.00, 'कृषि कार्यको लागि', 6);
...
-- Sample services
INSERT IGNORE INTO services (title, title_np, description, description_np, icon, display_order) VALUES
('Saving Account', 'बचत खाता', 'Open a saving account with attractive interest rates.', 'आकर्षक ब्याज दरमा बचत खाता खोल्नुहोस्।', 'fas fa-piggy-bank', 1),
('Loan Services', 'ऋण सेवा', 'Get easy loans for your various needs.', 'विभिन्न आवश्यकताहरूको लागि सजिलो ऋण प्राप्त गर्नुहोस्।', 'fas fa-hand-holding-usd', 2),
('Fixed Deposit', 'मुद्दती निक्षेप', 'Invest in fixed deposits for higher returns.', 'उच्च प्रतिफलको लागि मुद्दती निक्षेपमा लगानी गर्नुहोस्।', 'fas fa-lock', 3),
('Mobile Banking', 'मोबाइल बैंकिङ', 'Access your account anytime from your mobile.', 'आफ्नो मोबाइलबाट जुनसुकै समय खाता पहुँच गर्नुहोस्।', 'fas fa-mobile-alt', 4),
('Remittance', 'रेमिट्यान्स', 'Easy and secure money transfer services.', 'सजिलो र सुरक्षित रकम स्थानान्तरण सेवा।', 'fas fa-exchange-alt', 5),
('Insurance', 'बीमा', 'Get insurance coverage for your savings.', 'आफ्नो बचतको लागि बीमा कभरेज प्राप्त गर्नुहोस्।', 'fas fa-shield-alt', 6);
...
-- Sample team members
INSERT IGNORE INTO team_members (name, name_en, position, position_np, position_en, category, phone, email, display_order, is_information_officer, is_grievance_officer) VALUES
('राम बहादुर श्रेष्ठ', 'Ram Bahadur Shrestha', 'Chairperson', 'अध्यक्ष', 'Chairperson', 'board', '9827157000', 'chairman@coop.com', 1, 0, 0),
('सीता देवी थापा', 'Sita Devi Thapa', 'Vice Chairperson', 'उपाध्यक्ष', 'Vice Chairperson', 'board', '9801234568', NULL, 2, 0, 0),
('हरि प्रसाद पौडेल', 'Hari Prasad Poudel', 'Secretary', 'सचिव', 'Secretary', 'board', '9801234569', 'secretary@coop.com', 3, 0, 0),
('गीता कुमारी राई', 'Gita Kumari Rai', 'Treasurer', 'कोषाध्यक्ष', 'Treasurer', 'board', '9801234570', NULL, 4, 0, 0),
('कृष्ण बहादुर तामाङ', 'Krishna Bahadur Tamang', 'Manager', 'प्रबन्धक', 'Manager', 'management', '9801234571', 'manager@coop.com', 1, 0, 0);
...
-- Sample pages
INSERT IGNORE INTO pages (slug, title, title_np, title_en, content, content_np) VALUES
('about', 'About Us', 'हाम्रो बारेमा', 'About Us', 
'<h3>Our History</h3><p>Aakash Saving and Credit Cooperative was established with a vision to provide accessible financial services to the community.</p>',
'<h3>हाम्रो इतिहास</h3><p>आकाश बचत तथा ऋण सहकारी संस्था समुदायलाई सुलभ वित्तीय सेवा प्रदान गर्ने उद्देश्यले स्थापना गरिएको हो।</p>'),
('privacy-policy', 'Privacy Policy', 'गोपनीयता नीति', 'Privacy Policy', 
'<h3>Our Commitment to Privacy</h3><p>We value your privacy. This policy explains what information we collect, how we use it and how we protect it.</p>',
'<h3>हाम्रो गोपनीयता प्रति प्रतिबद्धता</h3><p>हामी तपाईंको गोपनीयतालाई महत्त्व दिन्छौं। यस नीतिमा हामीले कुन जानकारी सङ्कलन गर्छौं, कसरी प्रयोग गर्छौं र कसरी सुरक्षित राख्छौं भन्ने उल्लेख छ।</p>'),
('terms-of-service', 'Terms of Service', 'सेवाका सर्तहरू', 'Terms of Service',
'<h3>Terms of Service</h3><p>By using this website you agree to the following terms.</p>',
'<h3>सेवाका सर्तहरू</h3><p>यस वेबसाइट प्रयोग गर्दा तपाईं निम्न सर्तहरूमा सहमत हुनुहुन्छ।</p>'),
('cookie-policy', 'Cookie Policy', 'कुकी नीति', 'Cookie Policy',
'<h3>Cookie Policy</h3><p>We use cookies to keep you signed in and improve your experience.</p>',
'<h3>कुकी नीति</h3><p>हामी session सञ्चालन र अनुभव सुधार गर्न cookies प्रयोग गर्छौं।</p>');
...
-- Sample useful links
INSERT IGNORE INTO useful_links (title, title_np, url, icon, description, display_order) VALUES
('Nepal Rastra Bank', 'नेपाल राष्ट्र बैंक', 'https://www.nrb.org.np', 'fas fa-university', 'Central Bank of Nepal', 1),
('Department of Cooperatives', 'सहकारी विभाग', 'https://doc.gov.np', 'fas fa-building', 'Government of Nepal', 2),
('National Cooperative Federation', 'राष्ट्रिय सहकारी महासंघ', 'https://ncfnepal.com.np', 'fas fa-handshake', 'Nepal', 3);
...
-- Insert default committee types (mark default board as visible in navbar)
INSERT IGNORE INTO committee_types (name, name_np, display_order, show_in_navbar) VALUES
('Board of Directors', 'सञ्चालक समिति', 1, 1),
('Supervisory Committee', 'लेखा सुपरिवेक्षण समिति', 2, 1),
('Loan Committee', 'ऋण उपसमिति', 3, 0),
('Education Committee', 'शिक्षा उपसमिति', 4, 0),
('Women Committee', 'महिला उपसमिति', 5, 0),
('Youth Committee', 'युवा उपसमिति', 6, 0),
('Audit Committee', 'लेखा परीक्षण समिति', 7, 1);
...
INSERT IGNORE INTO chatbot_faqs (question, question_en, answer, answer_en, category, keywords, display_order) VALUES
('कार्यालय समय कति हो?', 'What are office hours?', 'हाम्रो कार्यालय आइतबार देखि शुक्रबार बिहान १०:०० बजे देखि साँझ ५:०० बजेसम्म खुला रहन्छ। शनिबार र सार्वजनिक बिदाको दिन बन्द रहन्छ।', 'Our office is open Sunday to Friday from 10:00 AM to 5:00 PM. Closed on Saturday and public holidays.', 'general', 'समय,time,office,कार्यालय', 1),
('बचत खाताको ब्याजदर कति हो?', 'What is savings interest rate?', 'हाम्रो बचत खाताको ब्याजदर ८% देखि १२% सम्म छ।', 'Our savings interest rate ranges from 8% to 12%.', 'interest', 'ब्याज,interest,बचत,saving', 2),
('ऋणको ब्याजदर कति हो?', 'What is loan interest rate?', 'हाम्रो ऋणको ब्याजदर १२% देखि १६% सम्म छ।', 'Our loan interest rate ranges from 12% to 16%.', 'interest', 'ब्याज,loan,ऋण', 3),
('सदस्य बन्न के गर्नुपर्छ?', 'How to become a member?', 'सदस्य बन्नको लागि नागरिकता, फोटो र न्यूनतम शेयर रकम चाहिन्छ।', 'To become a member you need citizenship, photos and minimum share amount.', 'membership', 'सदस्य,member,खाता', 4);
...
-- Sample FAQs
INSERT IGNORE INTO faqs (question, question_np, answer, answer_np, category, display_order) VALUES
('How can I become a member?', 'म कसरी सदस्य बन्न सक्छु?', 'To become a member, visit our nearest branch with citizenship and photos.', 'सदस्य बन्नको लागि नागरिकता र फोटो सहित नजिकको शाखामा जानुहोस्।', 'membership', 1),
('What types of savings accounts do you offer?', 'कस्ता बचत खाताहरू उपलब्ध छन्?', 'We offer Regular Savings, Fixed Deposit, Recurring Deposit and more.', 'हामी नियमित बचत, मुद्दती निक्षेप, आवधिक बचत आदि प्रदान गर्दछौं।', 'savings', 2);
...
-- Sample app features
INSERT IGNORE INTO app_features (title, title_np, icon, is_new, sort_order) VALUES
('Fund Transfer', 'फण्ड ट्रान्सफर', 'fas fa-exchange-alt', 0, 1),
('Bill Payment', 'बिल भुक्तानी', 'fas fa-file-invoice-dollar', 0, 2),
('QR Payment', 'QR भुक्तानी', 'fas fa-qrcode', 1, 3),
('Mobile Topup', 'मोबाइल टपअप', 'fas fa-mobile-alt', 0, 4),
('Wallet Load', 'वालेट लोड', 'fas fa-wallet', 1, 5),
('View Statement', 'स्टेटमेन्ट हेर्नुहोस्', 'fas fa-chart-line', 0, 6);
...
INSERT IGNORE INTO institutional_profile (fiscal_year, total_members, share_capital, deposit, loan, total_assets, npa_percent, profit_loss, is_active) VALUES
('2080/81', 5000, 50000000, 200000000, 180000000, 280000000, 2.5, 15000000, 1);
...
VALUES ('v2.0.0', 'Performance indexes + login_attempts + schema_migrations');
...
INSERT IGNORE INTO notification_templates (event_type, audience, channel, subject, body, variables) VALUES
('loan_application',    'admin','email','नयाँ ऋण आवेदन प्राप्त भयो ({tracking_id})',
 'नमस्कार Admin,\n\nनयाँ ऋण आवेदन प्राप्त भएको छ।\n\nTracking ID: {tracking_id}\nआवेदकको विवरण:\n{details}\n\n— {site_name}',
 '{tracking_id},{details},{site_name}'),
('grievance',           'admin','email','नयाँ गुनासो दर्ता भयो ({tracking_id})',
 'नमस्कार Admin,\n\nनयाँ गुनासो दर्ता भएको छ।\n\nTracking ID: {tracking_id}\nविवरण:\n{details}\n\n— {site_name}',
 '{tracking_id},{details},{site_name}'),
('digital_service',     'admin','email','नयाँ डिजिटल सेवा अनुरोध ({tracking_id})',
 'नमस्कार Admin,\n\nनयाँ डिजिटल सेवा अनुरोध आएको छ।\n\nTracking ID: {tracking_id}\nविवरण:\n{details}\n\n— {site_name}',
 '{tracking_id},{details},{site_name}'),
('kyc_application',     'admin','email','नयाँ KYC आवेदन ({tracking_id})',
 'नमस्कार Admin,\n\nनयाँ KYC आवेदन प्राप्त भयो।\n\nTracking ID: {tracking_id}\nविवरण:\n{details}\n\n— {site_name}',
 '{tracking_id},{details},{site_name}'),
('appointment',         'admin','email','नयाँ भेटघाट बुकिङ ({tracking_id})',
 'नमस्कार Admin,\n\nनयाँ भेटघाट बुकिङ छ।\n\nTracking ID: {tracking_id}\nविवरण:\n{details}\n\n— {site_name}',
 '{tracking_id},{details},{site_name}'),
('account_application', 'admin','email','नयाँ खाता खोल्ने आवेदन ({tracking_id})',
 'नमस्कार Admin,\n\nनयाँ खाता आवेदन प्राप्त भयो।\n\nTracking ID: {tracking_id}\nविवरण:\n{details}\n\n— {site_name}',
 '{tracking_id},{details},{site_name}'),
('job_application',     'admin','email','नयाँ जागिर आवेदन ({tracking_id})',
 'नमस्कार Admin,\n\nनयाँ जागिर आवेदन प्राप्त भयो।\n\nTracking ID: {tracking_id}\nविवरण:\n{details}\n\n— {site_name}',
 '{tracking_id},{details},{site_name}'),
('contact_message',     'admin','email','नयाँ सम्पर्क सन्देश',
 'नमस्कार Admin,\n\nनयाँ सम्पर्क सन्देश आएको छ।\n\nविवरण:\n{details}\n\n— {site_name}',
 '{details},{site_name}');

-- Admin SMS templates
INSERT IGNORE INTO notification_templates (event_type, audience, channel, subject, body, variables) VALUES
('loan_application',    'admin','sms', NULL, 'New Loan Application by {name}. Amount: {amount}. ID: {tracking_id} — {site_name}', '{name},{amount},{tracking_id},{site_name}'),
('grievance',           'admin','sms', NULL, 'New Grievance from {name}. ID: {tracking_id} — {site_name}', '{name},{tracking_id},{site_name}'),
('digital_service',     'admin','sms', NULL, 'New Digital Service Request. ID: {tracking_id} — {site_name}', '{tracking_id},{site_name}'),
('kyc_application',     'admin','sms', NULL, 'New KYC Application by {name}. ID: {tracking_id} — {site_name}', '{name},{tracking_id},{site_name}'),
('appointment',         'admin','sms', NULL, 'New Appointment by {name} on {date}. ID: {tracking_id} — {site_name}', '{name},{date},{tracking_id},{site_name}'),
('account_application', 'admin','sms', NULL, 'New Account Application by {name}. ID: {tracking_id} — {site_name}', '{name},{tracking_id},{site_name}'),
('job_application',     'admin','sms', NULL, 'New Job Application by {name}. ID: {tracking_id} — {site_name}', '{name},{tracking_id},{site_name}'),
('contact_message',     'admin','sms', NULL, 'New Contact Message from {name}. — {site_name}', '{name},{site_name}');

-- Member status-update templates (status + remarks)
INSERT IGNORE INTO notification_templates (event_type, audience, channel, subject, body, variables) VALUES
('loan',          'member','email','तपाईंको ऋण आवेदनको स्थिति: {status}',
 'नमस्कार {name} जी,\n\nतपाईंको ऋण आवेदन (ID: {tracking_id}) को स्थिति «{status}» मा अद्यावधिक भएको छ।\n\n{remarks}\n\nधन्यवाद,\n{site_name}',
 '{name},{status},{tracking_id},{remarks},{site_name}'),
('kyc',           'member','email','तपाईंको KYC आवेदनको स्थिति: {status}',
 'नमस्कार {name} जी,\n\nतपाईंको KYC आवेदन (ID: {tracking_id}) को स्थिति «{status}» मा अद्यावधिक भएको छ।\n\n{remarks}\n\nधन्यवाद,\n{site_name}',
 '{name},{status},{tracking_id},{remarks},{site_name}'),
('account',       'member','email','तपाईंको खाता आवेदनको स्थिति: {status}',
 'नमस्कार {name} जी,\n\nतपाईंको खाता आवेदन (ID: {tracking_id}) को स्थिति «{status}» मा अद्यावधिक भएको छ।\n\n{remarks}\n\nधन्यवाद,\n{site_name}',
 '{name},{status},{tracking_id},{remarks},{site_name}'),
('appointment',   'member','email','तपाईंको भेटघाट: {status}',
 'नमस्कार {name} जी,\n\nतपाईंको भेटघाट (ID: {tracking_id}) को स्थिति «{status}» मा अद्यावधिक भएको छ।\n\n{remarks}\n\nधन्यवाद,\n{site_name}',
 '{name},{status},{tracking_id},{remarks},{site_name}'),
('grievance',     'member','email','तपाईंको गुनासोको स्थिति: {status}',
 'नमस्कार {name} जी,\n\nतपाईंको गुनासो (ID: {tracking_id}) को स्थिति «{status}» मा अद्यावधिक भएको छ।\n\n{remarks}\n\nधन्यवाद,\n{site_name}',
 '{name},{status},{tracking_id},{remarks},{site_name}');

-- Member SMS templates
INSERT IGNORE INTO notification_templates (event_type, audience, channel, subject, body, variables) VALUES
('loan',        'member','sms', NULL, '{name} जी, तपाईंको ऋण आवेदन ({tracking_id}) को स्थिति: {status}. — {site_name}', '{name},{status},{tracking_id},{site_name}'),
('kyc',         'member','sms', NULL, '{name} जी, तपाईंको KYC आवेदन ({tracking_id}) को स्थिति: {status}. — {site_name}', '{name},{status},{tracking_id},{site_name}'),
('account',     'member','sms', NULL, '{name} जी, तपाईंको खाता आवेदन ({tracking_id}) को स्थिति: {status}. — {site_name}', '{name},{status},{tracking_id},{site_name}'),
('appointment', 'member','sms', NULL, '{name} जी, तपाईंको भेटघाट ({tracking_id}) को स्थिति: {status}. — {site_name}', '{name},{status},{tracking_id},{site_name}'),
('grievance',   'member','sms', NULL, '{name} जी, तपाईंको गुनासो ({tracking_id}) को स्थिति: {status}. — {site_name}', '{name},{status},{tracking_id},{site_name}');
...
-- Demo admin / पहिलो login: पासवर्ड admin panel मा बदल्नुपर्छ (public reset URL छैन)
...
-- ═══════════════════════════════════════════════════════════════
-- ✅  सबै tables, columns, indexes र seed data सफलतापूर्वक लोड भयो।
-- ═══════════════════════════════════════════════════════════════
