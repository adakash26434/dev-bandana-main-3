...
CSS;
        ...
        echo '<!DOCTYPE html><html lang="ne"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            ...
            . '<p class="svc-expired-hint">नवीकरण: कार्यालय प्रतिनिधिले <strong>Admin लग इन ठेगाना</strong> (<code>/admin/</code>) बाट भुक्तानी सूचना पठाउन सक्छन्। नवीकरण पुष्टि भएपछि सेवा पुनः खुल्छ — आन्तरिक व्यवस्थापन र मद्दतका लागि <strong>विक्रेता / प्राविधिक टोली</strong> सम्पर्क गर्नुहोस्।</p>'
