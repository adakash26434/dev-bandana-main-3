<?php
/**
 * Admin Pages Management (v2)
 * - गतिशील पृष्ठहरू: table/list + add/edit form (same page)
 * - स्थिर विषयवस्तु: table/list + add/edit form (same page)
 *
 * Old `pages.php` remains for backward compatibility.
 */
...
function pages_v2_tinymce(): void {
    static $loaded = false;
    if ($loaded) return;
    $loaded = true;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && (string)($_POST['action'] ?? '') === 'save_static_section') {
    ...
    redirect('pages-v2.php?tab=static&action=edit_static&page=' . urlencode($pageKey) . '&panel=form');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_dynamic_page'])) {
    ...
    if ($titleNp === '') {
        ...
        redirect('pages-v2.php?tab=dynamic&action=edit' . ($pageId > 0 ? '&id=' . $pageId : '') . '&panel=form');
    }
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a class="btn btn-sm btn-primary" href="pages-v2.php?tab=dynamic&action=edit&id=<?php echo (int)$pg['id']; ?>&panel=form" title="सम्पादन"><i class="fas fa-edit"></i></a>
                        ...
                        <div class="tab-pane fade <?php echo ($tab === 'dynamic' && ($action === 'edit' || $panel === 'form')) ? 'show active' : ''; ?>" id="pgv2-dyn-form" role="tabpanel">
                            <div class="card svc-flat-top-card">
                                <div class="card-header d-flex justify-content-between align-items-center svc-form-header-grad">
                                    ...
                                    <a class="btn btn-light btn-sm" href="pages-v2.php?tab=dynamic">
                                        ...
                                        <table class="table table-hover align-middle mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn-sm btn-primary" href="pages-v2.php?tab=static&action=edit_static&page=<?php echo urlencode($key); ?>&panel=form" title="सम्पादन"><i class="fas fa-edit"></i></a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                        ...
                        <div class="tab-pane fade <?php echo ($tab === 'static' && ($action === 'edit_static' || $panel === 'form')) ? 'show active' : ''; ?>" id="pgv2-st-form" role="tabpanel">
                            <div class="card svc-flat-top-card">
                                <div class="card-header d-flex justify-content-between align-items-center svc-form-header-grad">
                                    ...
                                    <a class="btn btn-light btn-sm" href="pages-v2.php?tab=static"><i class="fas fa-arrow-left me-1"></i>सूची</a>
                                </div>
                                <div class="card-body p-4">
