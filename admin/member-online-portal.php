...
.portal-member-meta-list .list-group-item {
    border-left: 0;
    border-right: 0;
}
.portal-partner-filter-wrap {
    background: linear-gradient(180deg, #f8fafc 0%, #ffffff 100%);
}
.portal-partner-filter-select {
    max-width: 380px;
}
.portal-partner-table-wrap {
    border-top: 1px solid #eef2f7;
}
.portal-partner-table thead th {
    font-size: 0.74rem;
    text-transform: uppercase;
    letter-spacing: 0.4px;
    color: #475569;
}
.portal-partner-table tbody td {
    padding-top: 9px;
    padding-bottom: 9px;
}
.portal-service-chip {
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-0">
        ...
        <div class="text-center py-5 text-muted">
            ...
            <?php echo $search || $filterStatus ? 'कुनै member फेला परेन।' : 'अहिलेसम्म कुनै Member दर्ता भएको छैन।'; ?>
        </div>
        <?php else: ?>
        <div class="table-responsive">
            <table class="table table-hover mb-0">
        ...
        <div class="d-flex justify-content-between align-items-center p-3 border-top">
            ...
            <nav><ul class="pagination pagination-sm mb-0">
                ...
                <li class="page-item <?php echo $pg===$page?'active':''; ?>">
                    <a class="page-link" href="?tab=members&page=<?php echo $pg; ?>&search=<?php echo urlencode($search); ?>&status=<?php echo urlencode($filterStatus); ?>"><?php echo $pg; ?></a>
                </li>
                <?php endfor; ?>
            </ul></nav>
        </div>
