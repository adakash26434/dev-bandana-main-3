            ...
            <div class="card-body">
                <form method="post" class="row g-2">
                    ...
                    <div class="col-12 d-flex gap-2 mt-2">
                        ...
                        <a class="btn btn-outline-secondary" href="designations.php">नयाँ</a>
                    </div>
                </form>
            </div>
        </div>
                        ...
                        <?php foreach ($list as $r): ?>
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <a class="btn btn-sm btn-outline-primary" href="?edit=<?php echo (int)$r['id']; ?>"><i class="fas fa-pen"></i></a>
