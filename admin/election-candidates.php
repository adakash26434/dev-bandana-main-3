        ...
        <div class="card admin-table-card mb-3">
            ...
            <div class="card-body">
                <form method="post" class="row g-2">
                    ...
                    <div class="col-12">
                        <label class="form-label small">Master पदबाट छान्नुहोस् <small class="text-muted">(option) — title, समिति, सिट auto-fill हुन्छ</small></label>
                        <select class="form-select" name="post_id" id="post_master_sel">
        ...
        <div class="card admin-table-card">
            ...
            <div class="table-responsive">
                <table class="table table-sm mb-0 align-middle">
                    ...
                    <?php endforeach; ?>
                    <?php if (empty($positions)): ?><tr><td colspan="4" class="text-center text-muted py-3">अझै पद थपिएको छैन।</td></tr><?php endif; ?>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div class="card admin-table-card">
            ...
            <div class="table-responsive">
                <table class="table table-sm mb-0 align-middle">
                    ...
                    <?php endforeach; ?>
                    <?php if (empty($cands)): ?><tr><td colspan="5" class="text-center text-muted py-3">अझै उम्मेदवार छैन।</td></tr><?php endif; ?>
                    </tbody>
                </table>
            </div>
        </div>
