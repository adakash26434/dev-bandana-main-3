...
<div class="admin-stat-grid">
  <div class="admin-stat-card"><div class="stat-icon info"><i class="fas fa-inbox"></i></div>
    <div><div class="stat-value"><?= (int)$counts['total'] ?></div><div class="stat-label">जम्मा KYC</div></div></div>
  <div class="admin-stat-card"><div class="stat-icon warn"><i class="fas fa-clock"></i></div>
    <div><div class="stat-value"><?= (int)$counts['pending'] ?></div><div class="stat-label">पेन्डिङ</div></div></div>
  <div class="admin-stat-card"><div class="stat-icon"><i class="fas fa-check"></i></div>
    <div><div class="stat-value"><?= (int)$counts['approved'] ?></div><div class="stat-label">स्वीकृत</div></div></div>
  <div class="admin-stat-card"><div class="stat-icon danger"><i class="fas fa-xmark"></i></div>
    <div><div class="stat-value"><?= (int)$counts['rejected'] ?></div><div class="stat-label">अस्वीकृत</div></div></div>
  <div class="admin-stat-card"><div class="stat-icon"><i class="fas fa-user-check"></i></div>
    <div><div class="stat-value"><?= (int)$counts['generated'] ?></div><div class="stat-label">सदस्य बनेका</div></div></div>
</div>
