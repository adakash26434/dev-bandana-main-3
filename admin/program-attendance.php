...
<div class="row g-3 mb-3">
  <div class="col-md-3"><div class="card admin-table-card"><div class="card-body py-2"><div class="small text-muted">पुरुष (Male)</div><div class="h5 mb-0"><?php echo (int)$genderCounts['male']; ?></div></div></div></div>
  <div class="col-md-3"><div class="card admin-table-card"><div class="card-body py-2"><div class="small text-muted">महिला (Female)</div><div class="h5 mb-0"><?php echo (int)$genderCounts['female']; ?></div></div></div></div>
  <div class="col-md-3"><div class="card admin-table-card"><div class="card-body py-2"><div class="small text-muted">अन्य (Other)</div><div class="h5 mb-0"><?php echo (int)$genderCounts['other']; ?></div></div></div></div>
  <div class="col-md-3"><div class="card admin-table-card"><div class="card-body py-2"><div class="small text-muted">Gender नभएको</div><div class="h5 mb-0"><?php echo (int)$genderCounts['unknown']; ?></div></div></div></div>
</div>
