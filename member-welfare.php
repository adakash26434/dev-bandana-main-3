...
.claim-type-item:hover, .claim-type-item.active {
    background: #f8f9fa;
...
/* Claim Form — unique styles only (universal box + form-icon handled by style.css) */
.claim-form .form-section h5 {
    font-weight: 600;
    margin-bottom: 15px;
    color: #333;
}
...
.type-option input:checked + .type-box {
    ...
    background: rgba(var(--type-color), 0.05);
